...
/// protocol as the ARDMX EVO tree's own [ArdmxEvoCycleProgrammingScreen],
/// minus the song/volume row at the bottom (no DFPlayer on this hardware).
class ArdmxOneV2CycleProgrammingScreen extends ConsumerStatefulWidget {
  const ArdmxOneV2CycleProgrammingScreen({super.key});

  @override
  ConsumerState<ArdmxOneV2CycleProgrammingScreen> createState() =>
      _ArdmxOneV2CycleProgrammingScreenState();
}

class _ArdmxOneV2CycleProgrammingScreenState
    extends ConsumerState<ArdmxOneV2CycleProgrammingScreen> {
